...
public class BrainEngine {
	...
	public void setPath(String filePath) throws InvalidInstruction, InvalidInstructionsSet, IOException {
		...
		System.out.println("Amount instructions in file: " + lineAmount);
		reader.close();
		parseBrain();
	}
	...
	//public static void main (String args[]) throws InvalidInstruction, InvalidInstructionsSet, IOException {
		//BrainEngine brainEngine = new BrainEngine();
		//brainEngine.setPath("n:/Brains/solution-1.brain");
		//System.out.println("File parsed to brain-No invalid instructions!");
	//}
